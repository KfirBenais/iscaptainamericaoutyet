...
export const translations = {
  en: {
    ...
    printRequest: {
      ...
      bannerSubtitle: 'Upload your file or share a link to get a price quote for a custom print — any shape, any color.',
      ...
      fileLabel: '3D Model *',
      fileModeUpload: '📁 Upload File',
      fileModeLink: '🔗 Share a Link',
      ...
      linkHint: 'Paste a link from MakerWorld, Thingiverse, Printables, Cults3D, MyMiniFactory, etc.',
      linkPlaceholder: 'https://www.thingiverse.com/thing:...',
      linkMissingAlert: 'Please enter a model link.',
      linkInvalidAlert: 'Please enter a valid URL (must start with http:// or https://).',
  ...
  he: {
    ...
    printRequest: {
      ...
      bannerSubtitle: 'העלו קובץ או שתפו קישור לקבלת הצעת מחיר להדפסה מותאמת — כל צורה, כל צבע.',
      bannerButton: 'קבלו הצעת מחיר',
      modalTitle: '🖨️ הדפסה מותאמת — הצעת מחיר',
      stepPrintDetails: 'פרטי ההדפסה',
      stepYourDetails: 'הפרטים שלכם',
      fileLabel: 'מודל תלת-ממד *',
      fileModeUpload: '📁 העלאת קובץ',
      fileModeLink: '🔗 שיתוף קישור',
      ...
      linkLabel: 'קישור למודל *',
      linkHint: 'הדביקו קישור מ-MakerWorld, Thingiverse, Printables, Cults3D, MyMiniFactory וכו׳',
      linkPlaceholder: 'https://www.thingiverse.com/thing:...',
      linkMissingAlert: 'אנא הזינו קישור למודל.',
      linkInvalidAlert: 'אנא הזינו כתובת URL תקינה (חייבת להתחיל ב-http:// או https://).',

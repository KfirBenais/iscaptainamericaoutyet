...
const colorPalette = [
  ...
  { name: 'Pink Magenta', className: 'pink-magenta' }
];
...
function App() {
  ...
  const products = [  
    { name: "Pokemon Keychain (Choose One)", price: 10, image: "./Images/pokemonKeyChain.jpeg", category: "Toys" },
    ...
    { name: "Snow Castle With Trees", price: 35, image: "./Images/ChurchCastle.jpeg", category: "Figurines" },
    { name: "Beyblade arena", price: 25, image: "./Images/Beyblade_arena.jpeg", category: "Toys" },
    { name: "Glasses Box", price: 25, image: "./Images/GlassesBox.jpeg", category: "Utilities" },
    { name: "Soda Can Opener", price: 5, image: "./Images/CanOpener.jpeg", category: "Utilities" },
    { name: "Birth Present", price: 35, image: "./Images/BirthPresent.webp", category: "Decorative" },
    { name: "Bag Clips", price: 2, image: "./Images/BagClips.jpg", category: "Utilities" },
    { name: "Bag Clips With Lid", price: 6, image: "./Images/BagClipsLid.jpeg", category: "Utilities" },
    { name: "Bunny Vortex", price: 10, image: "./Images/BunnyVortex.webp", category: "Fidgets" },
    { name: "Morf Worm", price: 10, image: "./Images/MorfWorm.webp", category: "Fidgets" },
    ...
    { name: "Fidget Collection", price: 12, image: "./Images/FidgetCollection.webp", category: "Fidgets" },
    ...
    { name: "Hamsa", price: 6, image: "./Images/Hamsa.jpg", category: "Decorative" },
    { name: "Heart KeyChain", price: 6, image: "./Images/HeartKeyChain.jpg", category: "Decorative" },
     { name: "Custom Photo Frame", price: 25, image: "./Images/CustomPhotoFrame.jpg", category: "Decorative" },
    ...
    { name: "Spinner", price: 10, image: "./Images/spinner.webp", category: "Fidgets" },
    ...
    { name: "Vortex Man", price: 10, image: "./Images/VortexMan.webp", category: "Decorative" },
    { name: "Vortex Pyramid", price: 10, image: "./Images/VortexPyramid.webp", category: "Fidgets" },
    { name: "Plane With Gun Set", price: 30, image: "./Images/PlaneWithGunSet.jpg", category: "Toys" },
    ...
    { name: "Large hexagon", price: 15, image: "./Images/Hexagon.webp", category: "Fidgets" },
    ...
    { name: "Small Labubu", price: 25, image: "./Images/SmallLabubu.jpg", category: "Figurines" },
    { name: "Large Labubu", price: 30, image: "./Images/LargeLabubu.jpg", category: "Figurines" },
    { name: "Pikachu Labubu", price: 30, image: "./Images/Labubupikachu.jpg", category: "Figurines" },
    ...
    { name: "Door Stopper", price: 6, image: "./Images/DoorStopper.jpg", category: "Utilities" },
